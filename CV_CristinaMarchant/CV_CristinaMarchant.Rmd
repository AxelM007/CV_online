...
Apoyo y desarrollo de instrumentos para la aplicación de encuestas en el contexto de Evaluación de Impacto de Programas de Migración Laboral en Australia y Nueva Zelanda.
...
tribble(
  ...
  2022, "Encuesta Nacional de Salud Sexual y Género", "MINSAL",
  2022, "Análisis Encuesta Educación rural en contexto COVID-19", "Fundación99",
  2021, "Línea Base Social Choshuenco y Paillahuinte", "Corporación Choshuenco",
  2021, "Estudio Orgullo de Chile, tercera versión", "Fundación Imagen de Chile",
  2021, "Encuesta Nacional Bicentenario 2021", "UC",
  2021, "Térmometro de Calidad de Vida y Salud", "ACHS Chile",
  2021, "Terreno de Evaluación de Impacto Programa Conecta Mayor", "Fundación Conecta Mayor",
...
tribble(
  ...
  "Pontificia Universidad Católica de Chile", "2021", "Docente Diseño y Análisis de Pruebas de campo",
